...
Write-Host "Chat Service Docker Start Script" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
$chatServiceDir = $scriptDir
$rootDir = (Get-Item $chatServiceDir).Parent.Parent.FullName

# Define paths to other services that chat service might depend on
