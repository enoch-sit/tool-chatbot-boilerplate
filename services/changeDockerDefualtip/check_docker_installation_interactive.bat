@echo off
REM Interactive Docker installation check script with password prompt
REM Prerequisites:
REM - PuTTY tools (plink.exe, pscp.exe) must be installed and in PATH
REM - SSH access to the remote server
REM Usage: check_docker_installation_interactive.bat [hostname]

setlocal enabledelayedexpansion

REM Get hostname
if "%~1"=="" (
    set /p HOST="Enter hostname (e.g., proj05@project-1-05.eduhk.hk): "
    if "!HOST!"=="" (
...
echo ========================================
echo Docker Installation Check Script (Interactive)
echo ========================================
echo Host: %HOST%
echo ========================================
